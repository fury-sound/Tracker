...
extension TrackerNavigationViewController: UICollectionViewDataSource {
    ...
    private func pinTracker(indexPath: IndexPath) {
        ...
        guard let trackerID = currentTrackerItem?.id else {
            print("error with trackerID \(String(describing: currentTrackerItem?.id))")
            return
        }
    ...
    private func editTracker(indexPath: IndexPath) {
        ...
        guard let trackerID = currentTrackerItem?.id else {
            print("error with trackerID \(String(describing: currentTrackerItem?.id)), editTracker, TrackerNavigationViewController")
            return
        }
